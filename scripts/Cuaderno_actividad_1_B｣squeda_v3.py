# -*- coding: utf-8 -*-
"""Cuaderno_Actividad_1_Búsqueda_v3.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1R-_Aoe_mfICiBTemkBP8cxEygl2hCn50
...
def main(MAP_ASCII,COSTS,algorithms,heuristic_number=1,use_animation=True):
    ...
    for algorithm in algorithms:
      ...
      # Close the viewer if using animation
      if use_animation:
          used_viewer.close()
